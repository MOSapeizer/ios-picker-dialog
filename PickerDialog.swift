...
//  Updated by Mos Lee on 04/19/2017
//
import Foundation
import UIKit
import QuartzCore
...
class PickerDialog: UIView, UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    private func createContainerView() -> UIView {
        ...
        let dialogSize = CGSize(width: 300,
                                height: 230 + kPickerDialogDefaultButtonHeight
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.addTarget(self, action: #selector(buttonTapped(sender:)), for: .touchUpInside)
        ...
        self.doneButton.setTitleColor(UIColor.lightGray, for: .normal)
